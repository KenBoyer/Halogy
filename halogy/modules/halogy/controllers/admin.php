...
class Admin extends MX_Controller {
	...
	function dashboard($days = '')
	{
		...
		if (!$this->halogy->get_num_pages())
		{
			...
			$output['message'] = '<p><strong>Congratulations</strong> - your new site is set up and ready to go!</strong> You can view your site <a href="/">here</a>.</p>';
		}
		else
		{
			...
			{
				$this->form_validation->set_error('You are still using the default Superuser password. Click on Your Account to change your password.');
			}
		}
