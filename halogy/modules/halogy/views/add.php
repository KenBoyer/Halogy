...
<div class="row-fluid">
	...
	<h2 class="underline">Administrator Details</h2>
	...
	<span class="help">
		<a href="javascript:void(0)" class="btn helpbutton" data-toggle="popover" data-original-title="Help" data-content="The username for the main administrator."><i class="icon-question-sign" title="Help"></i></a>
	</span>
	<br class="clear" />

	<label for="password">Password:</label>
	<?php echo @form_password('password', set_value('password', $data['password']), 'id="password" class="form-control"'); ?>
	<br class="clear" />

	<label for="confirmPassword">Confirm Password:</label>
	<?php echo @form_password('confirmPassword', set_value('confirmPassword', $data['confirmPassword']), 'id="confirmPassword" class="form-control"'); ?>
	<br class="clear" />

	<label for="adminEmail">Email:</label>
	<?php echo @form_input('adminEmail', set_value('adminEmail', $data['adminEmail']), 'id="adminEmail" class="form-control"'); ?>
	<span class="help">
		<a href="javascript:void(0)" class="btn helpbutton" data-toggle="popover" data-original-title="Help" data-content="The email for the main administrator."><i class="icon-question-sign" title="Help"></i></a>
	</span>
	<br class="clear" />
