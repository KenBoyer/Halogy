...
class Admin extends MX_Controller {
	...
	function export_tickets($webform = '')
	{
		// export tickets as CSV
		$this->load->dbutil();

		$query = $this->tickets->export_tickets($webform);
		...
		header("Content-Disposition: attachment; filename=form-tickets-".date('U').".csv");
		header("Content-Description: File Transfer");

		$this->output->set_output($csv);
	}

	function display_tickets($webform = '')
	{
		// export tickets as CSV
		$this->load->dbutil();
