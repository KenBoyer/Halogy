...
<?php if (in_array('images', $this->permission->permissions)): ?>
	<a href="<?php echo site_url('/admin/images/popup'); ?>" id="halogycms_editpic" rel="<?php echo site_url('/admin/images/popup'); ?>"><i class="icon-picture"></i></a>
<?php endif; ?>
<div id="halogycms_browser"><p style="text-align:center;"><i class="icon-spinner icon-spin icon-large"></i></p></div>
